...
public class SpikeonLeftScreen {
	...
	public SpikeonLeftScreen() throws SlickException {
	...
	public SpikeonLeftScreen(float x, float y) throws SlickException {
		 SpikeOnLeft = new Image("res/SpikeLeft.png");
		 SpikeOnRight = new Image("res/SpikeRight.png");
		 this.x = x;
		 this.y = y;
	...
	public void update(){ 
		...
		//updateScore();
		this.y -= Spike_Speed;
		if(y < 0 && DownGame.getYspikeBefore() < DownGame.GAME_HEIGHT - 500){
